...
CCCCCC FIXME remove all write/format until FIXME SHOW INDICES
...
c
      ...
      do 10 i=1,mxhdng
cccccc XXX
c        write(*,990) i,hdng(i),bg(i)
c 990    format(I2,' ''',A,''' is at ',I9,' in header')
cccccc XXX
         if(bg(i) .eq. 0) then
             j = j + 1
             idum(j) = i
...
cccccc XXX
      do 999 i=1,mxhdng
          write(*,998) i, bg(i), en(i)
  998     format('i=',I2,': bg=',I9,'    en=',I9)
  999 continue
cccccc XXX
      return
      end
